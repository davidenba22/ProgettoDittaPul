...
<head>
	<meta charset="UTF-8">
	<title>Ricerca Cliente - Easy Clean</title>
...
<body>
	...
	<form action=ricercaCliente method=Post>
		<table border=1 align=center style="margin-top:5%;">
			<tr align=center>
				<th><h3>Ricerca cliente</h3></th>
			</tr>
			<tr align=center>
	...
	<% 
		Cliente trv=(Cliente) request.getAttribute("clienteTrovato");
		if(trv != null){
	%>
		<table border=1 align=center style="margin-top:5%; margin-bottom: 5%">
			<tr align=center>
				<th><h3>Cliente trovato</h3></th>
			</tr>
			<tr align=center>
				<td>Nome: <%=trv.getNomeCliente()%></td>
			</tr>
			<tr align=center>
				<td>Cognome: <%=trv.getCognomeCliente()%></td>
			</tr>
			<tr align=center>
				<td>Codice Fiscale: <%=trv.getCfCliente()%></td>
			</tr>
			<tr align=center>
				<td>Username: <%= trv.getUserCliente() %></td>
			</tr>
			<tr align=center>
				<td>Password: <%= trv.getPwdCliente() %></td>
			</tr>
		</table>
	<%
		}
