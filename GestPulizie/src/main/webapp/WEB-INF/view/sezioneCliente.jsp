...
<body>
	<% 
		Optional<Cliente> cfCliente=(Optional<Cliente>) session.getAttribute("ClienteLoggato");
		if(cfCliente != null){
	%>
	...
	<p align=center style="font-size: 28px;">Benvenuto, <%= cfCliente.get().getNomeCliente() %> <%= cfCliente.get().getCognomeCliente() %></p>
	<%
		}
	%>
	<div class="footer">
