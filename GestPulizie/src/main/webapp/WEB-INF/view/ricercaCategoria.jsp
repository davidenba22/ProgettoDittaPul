...
<head>
	<meta charset="UTF-8">
	<title>Aggiungi Categoria - Easy Clean</title>
...
<body>
	...
	<form action=ricercaCategoria method=post>
	 	<table border=1 align=center style="margin-top:7%;">
			<tr align=center>
				<th><h3>Ricerca Categoria</h3></th>
			</tr>
			<tr align=center>
	...
	<% 
		CategoriaOperaio trv=(CategoriaOperaio) request.getAttribute("catTrovata");
	
		if(trv != null){
	%>
		<table border=1 align=center style="margin-top: 3%;">
			<tr align=center>
				<th><h3>Categoria trovata</h3></th>
			</tr>
			<tr align=center>
				<td>Nome Categoria: <%=trv.getNomeCategoria()%></td>
			</tr>
			<tr align=center>
				<td>Stipendio: <%=trv.getStipendio()%> €</td>
			</tr>
		</table>
	...
	%>
	<br>
		<div id="flag" align=center>${Messaggio}</div>
	<%
		}
	%>
	<div class="footer">
